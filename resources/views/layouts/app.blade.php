    ...
    <div class="min-h-screen flex">
        ...
        <aside class="hidden lg:flex lg:flex-col lg:w-64 bg-dark-bg text-gray-100 border-r border-gray-800">
            <div class="flex items-center h-16 px-6 border-b border-gray-800">
                ...
                <span class="ml-3 text-xl font-semibold">Sr Fiesta</span>
            </div>
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('paquetes.index') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg {{ request()->routeIs('paquetes.*') ? 'bg-primary text-white' : 'text-gray-300 hover:bg-gray-800' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
