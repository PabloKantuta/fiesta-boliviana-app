...
Route::get('/', function () {
    if (auth()->check()) {
        // Si está autenticado, redirigir a alquileres
...
Route::middleware('auth')->group(function () {
    ...
    // Ruta del dashboard - redirige a alquileres (funcionalidad principal)
    ...
    // --- RUTAS DE ALQUILERES (FUNCIONALIDAD PRINCIPAL IMPLEMENTADA) ---
